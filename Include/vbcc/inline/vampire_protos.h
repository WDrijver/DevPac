...
UBYTE * __V_AllocExpansionPort(__reg("a6") void *, __reg("d0") ULONG unitNum, __reg("a1") CONST_STRPTR name)="\tjsr\t-6(a6)";
...
ULONG __V_EnableAMMX( __reg("a6") void *, __reg("d0") ULONG version) = "\tjsr\t-18(a6)";
