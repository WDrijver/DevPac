...
*
	...
	EITEM	RGBFB_Y4U2V2	; 2 Byte TrueColor YUV (CCIR recommendation CCIR601).
	...
	EITEM	RGBFB_Y4U1V1	; 1 Byte TrueColor ACCUPAK. Four adjacent pixels form
...
RGBFF_Y4U2V2		EQU	(1<<RGBFB_Y4U2V2)
RGBFF_Y4U1V1		EQU	(1<<RGBFB_Y4U1V1)
